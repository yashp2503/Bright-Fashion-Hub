...
<head>
    ...
    <title>Home |  Bright Fashion Hub</title>
    ...
    <div class="all-content">
      ...
      <div class="sticky-top">
              ...
              <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="../uploads/1.jpg" class="d-block col-md-12 py-10 py-md-0" alt="">
                  </div>
                  <div class="carousel-item">
                    <img src="../uploads/2.1.jpg" class="d-block col-md-12 py-10 py-md-0" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img src="../uploads/3.jpg" class="d-block col-md-12 py-10 py-md-0" alt="...">
                  </div>
                </div>
              </div>  

              <span style="position: absolute; left: 1vmin; bottom: 5vmin;">
              <h3 class="text-white fw-bold">Navratri Collection <br> Chanya CHori</h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12">
                            <h4 class="heading2 mb-3"><span></span></h4>
                            <div class="row">
        ...
        <section id="top-cards mt-0">
          <div class="heading2"><span></span></div>
          <div class="container">
            <div class="row">
          ...
          <div class="container ">
            <div class="row">
              ...
              <div class="col-md-5" id="col">
                <h1>Info</h1>
                <p><img src="../icons/email.svg" width="20px" height="20px">  jayesh200316@gmail.com</p>
                <p><img src="../icons/phone.svg" width="20px" height="20px">  +91 9898474437</p>
                <p><img src="../icons/location.svg" width="20px" height="20px"></i> Vadodara,Gujrat,India</p>
