...
<head>
    ...
    <title>Checkout |  Bright Fashion Hub</title>
                ...
                <form action="placeorder.php" method="post">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-5">
                            ...
                            <button type="submit" name="onlinePayBtn" class="btn text-white w-100" style="background-color: #b2744c"> onlinePayBtn</button>
                        </div>
