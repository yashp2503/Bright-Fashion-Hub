    ...
    if($totalUsers != 0) {
        while($result = mysqli_fetch_assoc($data)) {
            ...
            echo "<tr>
                    ...
                    <td><a href='update_user.php?id=$result[id]' class='update-btn'>Update</a></td>
                    <td><a href='delete_user.php?id=$result[id]' class='delete-btn' onclick='return checkdelete()'>Delete</a></td>
                  </tr>"; 
        }
    } else { 
